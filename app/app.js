(function(){
  ...
  dom.mind.addEventListener('pointercancel',()=>state.mind.drag=false);
  ...
  dom.brain.addEventListener('pointercancel',()=>{state.graph.drag=false;state.graph.dragNode=null;dom.tooltip.hidden=true});
